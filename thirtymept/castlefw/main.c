...
#define CWT0OVFS 4882	// number of timer0 overflows per dit --> T0OVS = (ditlength/s * 1MHz/2048)
...
// CASTLE 10  10-FSK tones for 10140020 Hz
// Word order: first 5 are dit freqs, last 5 are dah freqs
const uint8_t castleTones[10][5] = {
	{0x6a,0x52,0x23,0x28,0x0},
	{0xdc,0x52,0x23,0x28,0x0},
	{0xf8,0x52,0x23,0x28,0x0},
	{0x20,0x52,0x23,0x28,0x0},
	{0x17,0x92,0x23,0x28,0x0},
	{0xb1,0x52,0x23,0x28,0x0},
	{0x95,0x52,0x23,0x28,0x0},
	{0x23,0x52,0x23,0x28,0x0},
	{0x7,0x52,0x23,0x28,0x0},
	{0xdf,0x52,0x23,0x28,0x0},
};
...
int main(void)
{
	...
	while(1)
	{
		switch(currstate)
		{
			...
			case MEPT_TX_DELAY:
				if(unitcnt < 30) nextstate = MEPT_TX_DELAY;
